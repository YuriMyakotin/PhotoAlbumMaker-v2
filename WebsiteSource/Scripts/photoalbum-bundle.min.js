 ...
 * @license GPLv3
 */
let colors=[],CurrentFolderID=0;const Folders=new Map;let ThumbSize=0,ImgLightGallery,SiteName="",SiteDescription="",isPrivate=!1,Version=0,RootFolders=[];const L=atob("RkEyMzEzQkItQ0UzMTQ5Q0YtQUJDOUUxNEYtMTVCRkU2RkI=");document.addEventListener("DOMContentLoaded",async function(){const i=await fetch("Site.json"),n=await i.json();colors=n.FolderColors;document.body.style.backgroundColor=n.BgColor;const t={};for(let n=0;n<document.styleSheets.length;++n){const i=document.styleSheets[n].cssRules;for(let n=0;n<i.length;++n)t[i[n].selectorText]=i[n]}t[".folder-name"].style.color=n.FolderNameColor;t[".video-name"].style.color=n.VideoNameColor;t[".cmnt"].style.color=n.ImageDescriptionColor;t[".ImgName"].style.color=n.ImageNameColor;t[".top_navigation"].style.color=n.NavBarCurrentFolderColor;t[".FolderLink"].style.color=n.NavBarLinkColor;t[".bottom-info-bar"].style.color=n.InfoBarColor;t[".folder-desc"].style.color=n.FolderDescriptionColor;t[".ExifInfo"].style.color=n.ExifInfoColor;t[".GpsInfo"].style.color=n.GPSInfoColor;n.D!=null&&(SiteDescription=n.D);n.P!=null&&(isPrivate=n.P);n.V!=null&&(Version=n.V);ThumbSize=n.TS;SiteName=n.N;window.sitestats.innerHTML=n.TIC.toString()+" images, "+n.TVC.toString()+" videos, last updated "+n.LC;window.siteversion.innerHTML=(Version/100).toFixed(2).toString();const r=n.F;r.forEach(n=>{n.SubFolders=[],Folders.set(n.I,n)});Folders.forEach(n=>{n.PI===0?RootFolders.push(n.I):Folders.get(n.PI).SubFolders.push(n.I)});LoadAlbum(0)});